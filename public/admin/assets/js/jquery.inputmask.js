    ...
    return modules = [ function(module, exports, __webpack_require__) {
        ...
        Inputmask.extendAliases({
            datetime: {
                ...
                skipOptionalPartCharacter: "",
                i18n: {
                    dayNames: [ "B.", "Ç.", "Ça.", "Ca.", "C.", "Ş.", "B." ],
                    monthNames: [ "Yan", "Fev", "Mar", "Apr", "May", "İyn", "İyl", "Avq", "Sen", "Okt", "Noy", "Dek", "Yanvar", "Fevral", "Mart", "Aprel", "May", "İyun", "İyul", "Avqust", "Sentyabr", "Oktyabr", "Noyabr", "Dekabr" ],
                    ordinalSuffix: [ "-inci", "-inci", "-üncü", "-üncü" ]
                },
